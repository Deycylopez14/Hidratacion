  ...
  return (
    <div className="flex flex-col items-center">
      <input
        ...
        className="border-2 rounded-xl px-4 py-3 w-36 text-center text-2xl font-bold text-primary bg-[var(--color-white)] shadow transition-all duration-200 outline-none"
        style={{ borderColor: '#94E7FF', fontVariantNumeric: 'tabular-nums' }}
      />
