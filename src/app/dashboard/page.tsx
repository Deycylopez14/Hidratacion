      ...
      <div className="container-responsive w-full rounded-xl shadow-lg p-4 sm:p-6 mt-4 sm:mt-8 mb-16 relative z-10 overflow-hidden" style={{ background: '#F8FCFF', boxShadow: '0 8px 24px 0 rgba(0,0,0,0.10)' }}>
        ...
        <section className="max-w-2xl mx-auto mt-4 sm:mt-6 rounded shadow p-4 sm:p-6 mb-4" style={{ background: '#EFFBFF' }}>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs sm:text-sm font-bold text-primary">{DAILY_GOAL.toLocaleString()} <span className="text-[11px] sm:text-sm font-bold">{unit}</span></span>
          </div>
          <div className="flex justify-between text-center mb-2">
            <div>
              <div className="text-primary text-xl font-bold drop-shadow">{total.toLocaleString()} <span className="text-base font-bold">{unit}</span></div>
            ...
            <div>
              <div className="text-accent text-xl font-bold drop-shadow">{restante.toLocaleString()} <span className="text-base font-bold">{unit}</span></div>
        ...
        <section className="container-responsive w-full grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-4 mb-8 mt-4">
          ...
          <div className="rounded-xl shadow-lg p-3 text-center flex flex-col items-center gap-1 border border-[#006691] hover:scale-[1.03] transition-all duration-200" style={{ background: '#006691' }}>
            ...
            <div className="text-white text-lg font-extrabold drop-shadow">
              {avg.toLocaleString()}<span style={{ marginLeft: 4 }} />
          ...
          <div className="rounded-xl shadow-lg p-3 text-center flex flex-col items-center gap-1 border border-[#006691] hover:scale-[1.03] transition-all duration-200" style={{ background: '#006691' }}>
            ...
            <div className="text-white text-lg font-extrabold drop-shadow">
              {best.toLocaleString()}<span style={{ marginLeft: 4 }} />
              <span className="text-base font-bold">ml</span>
            </div>
          ...
          <div className="rounded-xl shadow-lg p-3 text-center flex flex-col items-center gap-1 border border-[#006691] hover:scale-[1.03] transition-all duration-200" style={{ background: '#006691' }}>
            ...
            <div className="text-white text-lg font-extrabold drop-shadow">{DAILY_GOAL.toLocaleString()} <span className="text-base font-bold">{unit}</span></div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-4 mb-4 w-full">
            <div className="flex-1 flex flex-col items-center justify-center bg-white rounded-lg p-3 shadow border border-[#003366]/20 min-w-[120px] max-w-[180px] mx-auto">
              <label className="flex items-center gap-2 text-[#003366] font-semibold cursor-pointer text-base">
                <span className="border-2 border-[#003366] rounded-full p-0.5 flex items-center justify-center">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-white rounded-lg p-3 shadow border border-[#003366]/20 min-w-[120px] max-w-[180px] mx-auto">
              <label className="flex items-center gap-2 text-[#003366] font-semibold cursor-pointer mb-2 text-base">
                <span className="border-2 border-[#003366] rounded-full p-0.5 flex items-center justify-center">
                  <svg className="w-4 h-4 text-[#003366]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3" /></svg>
                </span>
                Frecuencia
              </label>
              <input
